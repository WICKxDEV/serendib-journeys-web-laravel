                    ...
                    <form action="{{ route('admin.tours.update', $tour) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" id="description" rows="4" 
                                      class="form-control @error('description') is-invalid @enderror" required>{{ old('description', $tour->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="date" name="available_from" id="available_from" 
                                       value="{{ old('available_from', $tour->available_from) }}" 
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="date" name="available_to" id="available_to" 
                                       value="{{ old('available_to', $tour->available_to) }}" 
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="itinerary" id="itinerary" rows="6" 
                                      ...
                                      placeholder="Enter detailed itinerary for the tour..." required>{{ old('itinerary', $tour->itinerary) }}</textarea>
                            @error('itinerary')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="form-text">

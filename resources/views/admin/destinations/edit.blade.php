                    ...
                    <form action="{{ route('admin.destinations.update', $destination) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" id="description" rows="4" 
                                      ...
                                      placeholder="Enter detailed description of the destination..." required>{{ old('description', $destination->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="form-text">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="category" id="category" class="form-select @error('category') is-invalid @enderror" required>
                                    ...
                                    <option value="Historical" {{ old('category', $destination->category) == 'Historical' ? 'selected' : '' }}>Historical</option>
